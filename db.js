...
module.exports = {
    ...
    sql: {
        ...
        selectStateQuery: "select state,case_count,recovered_count,death_count from covid_status_dashboard where update_date = (select distinct update_date from covid_status_dashboard order by 1 desc limit 1) and state <> 'All India'  order by 2 desc limit 20",
