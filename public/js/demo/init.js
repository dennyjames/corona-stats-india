...
$.get("/all", function (data, status) {
    ...
    let stateDataForTable = data.filter(i => i.state !== 'All India').map(i => {
        i.mortalityRateForSort = ((i.death_count / i.case_count) * 100).toFixed(2)
        i.recoveredRateForSort = ((i.recovered_count / i.case_count) * 100).toFixed(2);
        i.mortalityRate = i.mortalityRateForSort + '%';
        i.recoveredRate = i.recoveredRateForSort + '%';
        if (i.totaldelta != 0)
    ...
    var table = new Tabulator("#state-table", {
        ...
        columns: [                 //define the table columns
            ...
            {
                title: "Total", field: "case_count", hozAlign: "left", minWidth: 55, cssClass: "total-column-blue",
            ...
            {
                title: "Deaths", field: "death_count", hozAlign: "left", minWidth: 55, cssClass: "death-column-red",
                sorter: function (a, b, aRow, bRow, column, dir, sorterParams) {
            ...
            },
            {
                ...
                minWidth: 100,
                sorter: function (a, b, aRow, bRow, column, dir, sorterParams) {
                    return aRow._row.data.recoveredRateForSort - bRow._row.data.recoveredRateForSort;
                }
            },
            {
                title: "Mortality",
                ...
                minWidth: 100,
                sorter: function (a, b, aRow, bRow, column, dir, sorterParams) {
                    return aRow._row.data.mortalityRateForSort - bRow._row.data.mortalityRateForSort;
                }
            },
        ...
        let doughnut = new Chart(donutCtx, {
            ...
            data: {
                datasets: [{
                    ...
                    backgroundColor: ['#edc915', '#23ba6a', '#bf2424'
                    ],
                }],
                labels: [
                        ...
                        generateLabels: function (chart) {
                            ...
                            if (data.labels.length && data.datasets.length) {
                                return data.labels.map(function (label, i) {
                                    ...
                                    total = chart.config.data.datasets[arc._datasetIndex].data.reduce((total, i) => parseInt(total) + parseInt(i));
                                ...
                                }).concat([{text: 'Total : ' + total, },
                                    {text: 'Recovery Rate : ' + recoveryRate, fillStyle : '#23ba6a'},
                                    {text: 'Mortality Rate : ' + mortalityRate, fillStyle : '#bf2424'}]);
                            } else {
                                return [];
                            }
                        }
