...
(select nextval('covid_status_dashboard_db_id') covid_status_dashboard_db_id, 'All India' as state, sum(case_count)+2970  case_count, sum(recovered_count) recovered_count ,sum (death_count) death_count
